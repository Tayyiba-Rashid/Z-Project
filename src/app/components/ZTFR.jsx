                            ...
                            <>
                                <div
                                    ...
                                    <div className="flex justify-center items-center w-full h-full">
                                        <p className="[writing-mode:vertical-rl] rotate-180 3xl:text-[12px] 2xl:text-[9px] xl:text-[8px] lg:text-[7px] md:text-[9px] sm:text-[7px] text-[7px] text-white text-center md:leading-5 lg:tracking-widest tracking-[0.2em]">UPLOAD FILES OR FOLDERS BY DROPPING <br /> THEM ANYWHERE IN THIS WINDOW
                                        </p>
                                    </div>
                                    {/* OUTER TEXT */}
                                            ...
                                            <div className='absolute  top-full right-0 bg-black rounded-b-2xl h-[400%] 3xl:w-[314px] 2xl:w-[265px] xl:w-[245px] lg:w-[235px] md:w-[300px] sm:w-[225px] w-[225px] '>
                                                ...
                                                <div className='w-full h-full flex flex-col px-[19px]'>
                                                    ...
                                                    <div className='text-white h-1/5 flex justify-end items-center'>
                                                        <svg
                                                            className='size-4 md:size-4 xl:size-5 2xl:size-[6.71]'
                                                            xmlns="http://www.w3.org/2000/svg"
